...
food = pygame.image.load("/Users/erkemusss/Desktop/pp2/lab10-2 /Food.png").convert_alpha()
...
class Snake:
    def __init__(self):
        ...
        self.snake_head_down  = pygame.image.load("/Users/erkemusss/Desktop/pp2/lab10-2 /SnakeHeadDown.png").convert_alpha()
        self.snake_head_down  = pygame.transform.scale(self.snake_head_down, (BLOCK_SIZE, BLOCK_SIZE))

        self.snake_head_up    = pygame.image.load("/Users/erkemusss/Desktop/pp2/lab10-2 /SnakeHeadUp.png").convert_alpha()
        self.snake_head_up    = pygame.transform.scale(self.snake_head_up, (BLOCK_SIZE, BLOCK_SIZE))

        self.snake_head_right = pygame.image.load("/Users/erkemusss/Desktop/pp2/lab10-2 /SnakeHeadRight.png").convert_alpha()
        self.snake_head_right = pygame.transform.scale(self.snake_head_right, (BLOCK_SIZE, BLOCK_SIZE))

        self.snake_head_left  = pygame.image.load("/Users/erkemusss/Desktop/pp2/lab10-2 /SnakeHeadLeft.png").convert_alpha()
...
class Main:
    def __init__(self):
        ...
        self.food  = Food()
        self.timer = Timer()
        self.user_level = self.get_user_level()  # Получаем уровень пользователя

    def get_user_level(self):
        # Здесь должен быть код для получения уровня пользователя из базы данных
        # Возвращаем уровень пользователя или уровень по умолчанию, если пользователь новый
        return 1
    ...
    def draw_level(self):
        level      = font_small.render(f"level: {self.user_level}", True, "black")  # Используем уровень пользователя
